            ...
            <div class="container">
					...
					<table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
									<img src="admin/assets/property/<?php echo $row['18'];?>" alt="pimage">
                                    <div class="property-info d-table">
                                        <h5 class="text-secondary text-capitalize"><a href="propertydetail.php?pid=<?php echo $row['pid'];?>"><?php echo $row['title'];?></a></h5>
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-success font-13"></i>&nbsp; <?php echo $row['state'];?></span>
