...
if(isset($_POST['add'])) {
    ...
    move_uploaded_file($temp_name, "admin/assets/property/$aimage");
    move_uploaded_file($temp_name1, "admin/assets/property/$aimage1");
    move_uploaded_file($temp_name2, "admin/assets/property/$aimage2");
    move_uploaded_file($temp_name3, "admin/assets/property/$aimage3");
    move_uploaded_file($temp_name4, "admin/assets/property/$aimage4");
    
    move_uploaded_file($temp_name5, "admin/assets/property/$fimage");
    move_uploaded_file($temp_name6, "admin/assets/property/$fimage1");
    move_uploaded_file($temp_name7, "admin/assets/property/$fimage2");
									...
									<div class="col-xl-6">
										<div class="form-group row">
											...
											<div class="col-lg-9">
												...
												<img src="admin/assets/property/<?php echo $row['18'];?>" alt="pimage" height="150" width="180">
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-9">
												...
												<img src="admin/assets/property/<?php echo $row['20'];?>" alt="pimage" height="150" width="180">
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-9">
												...
												<img src="admin/assets/property/<?php echo $row['22'];?>" alt="pimage" height="150" width="180">
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												...
												<img src="admin/assets/property/<?php echo $row['26'];?>" alt="pimage" height="150" width="180">
											</div>
										</div>
									</div>
									<div class="col-xl-6">
										<div class="form-group row">
											...
											<div class="col-lg-9">
												...
												<img src="admin/assets/property/<?php echo $row['19'];?>" alt="pimage" height="150" width="180">
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-9">
												...
												<img src="admin/assets/property/<?php echo $row['21'];?>" alt="pimage" height="150" width="180">
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-9">
												...
												<img src="admin/assets/property/<?php echo $row['25'];?>" alt="pimage" height="150" width="180">
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-9">
												...
												<img src="admin/assets/property/<?php echo $row['27'];?>" alt="pimage" height="150" width="180">
											</div>
										</div>
									</div>
								</div>
